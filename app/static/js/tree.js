...
! function () {
	...
	! function auto () {
        ...
        if (array[array.length-1] > 180){
            var r=parseInt(Math.random()*(array.length-40)+40, 10);
            pointer.x = canvas.centerX + canvas.centerX * Math.cos(angleX += array[r]/4040) * 0.20;
            pointer.y = canvas.centerY + canvas.centerY * Math.sin(angleY += array[r]/3020) * 0.25;
